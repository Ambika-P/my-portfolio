...
const GallerySection = () => {
  ...
  // ✅ Local images from /public/images
  const galleryImages = [
    { url: "/images/LLM-dash.png", title: "Learning Labs LMS", description: "Role-based LMS with AI features like MCQ generation and recommendation" },
    { url: "/images/chart4.png", title: "Learning Labs LMS", description: "Role-based LMS with AI features like MCQ generation and recommendation" },
    { url: "/images/chart5.png", title: "Learning Labs LMS", description: "Role-based LMS with AI features like MCQ generation and recommendation" },
    { url: "/images/LLM-cert.png", title: "Learning Labs LMS", description: "Role-based LMS with AI features like MCQ generation and recommendation" },
    { url: "/images/rmc.png", title: "RMC Portal", description: "Dynamic repair & maintenance system for tracking and reports" },
    { url: "/images/easy.png", title: "EasyTime System", description: "Employee timesheet & productivity tracking tool" },
    { url: "/images/chart3.png", title: "EasyTime System", description: "Employee timesheet & productivity tracking tool" },
    { url: "/images/chat.jpg", title: "DocGenie", description: "Medical consultation platform with upload & text-to-speech features" },
    { url: "/images/bosch1.jpg", title: "Predictive Engine UI", description: "Dashboard built for predictive maintenance (BOSCH)" },
    { url: "/images/bosch2.jpg", title: "Data Charts - Predictive App", description: "Recharts-based fault analytics module with filters" },
    { url: "/images/chart1.png", title: "", description: "" },
    { url: "/images/chart2.png", title: "", description: "" },
  ];
  ...
  return (
    <section
      id="gallery"
      ref={sectionRef}
      className="py-20 bg-white dark:bg-gray-900 reveal"
    >
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="section-title text-center mx-auto text-gray-900 dark:text-white">
          UI Design Highlights
